        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                @if ($errors->any())
                    <div class="mb-5" role="alert">
                        ...
                        <div class="px-4 py-3 text-red-700 bg-red-100 border border-t-0 border-red-400 rounded-b">
                            <p>
                            <ul>
                                {{-- Notif : The name must not be greatertahn 255 character --}}
                ...
                <form class="w-full" action="{{ route('admin.bookings.update', $booking->id) }}" method="post"
                    ...
                    @csrf
                    @method('PUT') {{-- Fungsi ini akan mengarahkan Pada bagian BookingController / Update --}}
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Nama booking. Contoh: Muhammad Arginanta Kafi Sambada.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Alamat booking. Contoh: Pondok Jati Blok Z no.9.
                            </div>
                        </div>
                    </div>
